...
<head>
	...
	<title>BLOG | by Creative Tim</title>
...
<body class="blog-post">
	...
	<div class="page-header header-filter" data-parallax="active" style="background-image: url('img/x.jpg');">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h1 class="title">IOT Based Attendance System – Overview</h1>
					<h4>Our IOT-based time and attendance tracking software are based on a flexible and adaptive system. We are capable enough to accommodate any custom requirements. Our cloud-based time and attendance tracking software are plain & simple which does not need the environment for managing and updating the system.</h4>
					<br />
									</div>
			</div>
		</div>
	...
	<!-- <footer class="footer footer-black">
		<div class="container">
			<a class="footer-brand" href="blog.php">Creative TM</a>
