                ...
                <div class="card">
                     <div class="col-md-12">
                        <form id="TypeValidation" class="form-horizontal" action="function.php" method="post">
                            ...
                            $ret=mysqli_query($dbconfig,"select * from  ct_blog where PageType='aboutus'");
                            $cnt=1;
                            ...
                            ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            <label class="control-label"></label>
                                            <textarea name="pagedes" id="pagedes" rows="5" class="form-control"><?php  echo $row['PageDescription'];?></textarea> </div>                                                
                                        </div>
                                    </div>
                                    <label class="col-sm-3 label-on-right">
                                    </label>
                            ...
                            <div class="card-footer text-center">
                                <button type="submit" name="update_about-us" class="btn btn-rose btn-fill">Submit</button>
                            </div>
                            <?php 
                            }
                            ?>
