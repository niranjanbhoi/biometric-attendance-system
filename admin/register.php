...
<!-- Mirrored from material-dashboard-pro-laravel.creative-tim.com/register by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 03:34:27 GMT -->
...
<head>
    ...
    <title>
     Register | Biometric Attendence Monitaring
    </title>
    ...
    <meta itemprop="image" content="../s3.amazonaws.com/creativetim_bucket/products/158/thumb/opt_mdp_laravel_thumbnail.jpg">
    ...
    <meta name="twitter:image" content="../s3.amazonaws.com/creativetim_bucket/products/158/thumb/opt_mdp_laravel_thumbnail.jpg">
    ...
    <meta property="og:image" content="../s3.amazonaws.com/creativetim_bucket/products/158/thumb/opt_mdp_laravel_thumbnail.jpg"/>
    ...
    <!-- CSS Files -->
    <link href="material/css/material-dashboard1c51.css?v=2.1.2" rel="stylesheet" />
...
<div class="wrapper wrapper-full-page">
    <div class="page-header register-page header-filter" filter-color="black" style="background-image: url('../img/x.jpg'); background-size: cover; background-position: top center;align-items: center;">
          ...
          <div class="row">
            ...
            <div class="col-md-5 mr-auto">
              ...
              if(isset($_SESSION['status']) && $_SESSION['status'] !='') 
                  {
                      echo '<h4 class="card-title text-center"> '.$_SESSION['status'].' </h4>';
                      unset($_SESSION['status']);
                  }
              ?>
              <form class="form" method="POST" action="function.php">
                <input type="hidden" name="_token" value="gzb6NtVZqdxj3VwzlhGyunMbph2kOh9ByZkZFZPh">
                ...
                <div class="text-center">
                  <button type="submit" name="signup_btn" class="btn btn-primary btn-round mt-4">Get Started</button>
                </div>
              </form>
            </div>
          </div>
  ...
  <div class="container">
    <nav class="float-left">
      ...
      <a href="###">
        ...
        <script src="material/js/material-dashboardf066.js?v=2.1.0" type="text/javascript"></script>
        <!-- Material Dashboard DEMO methods, don't include it in your project! -->
        <script src="material/demo/demo.js"></script>
        <script src="material/js/application.js"></script>
        <script src="material/demo/jquery.sharrre.js"></script>
        <script>
